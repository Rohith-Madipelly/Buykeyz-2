...
export const APP_NAME = 'Buykeyz';

export const PRIMARY_COLOR="#4A3AFF"
export const PRIMARY_LIGHT_COLOR="#C3BFF9"
export const SECONDARY_COLOR="#283E71"
export const APP_SECONDARY_BACKGROUND_COLOR="dcs"


export const IOS_BOTTOM_PADDING=false
...
export const THEME_COLOR = "rgba(40, 62, 113, 1)" 
...
export const NEWPAGE_1="white"
export const NEWPAGE_2="black"
