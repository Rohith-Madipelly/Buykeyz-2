...
const DeleteAccountPolicy = ({ navigation }) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: GlobalStyles.AuthScreenStatusBar1.color }}>
      ...
      <CustomToolKitHeader componentName={"Delete Account Policy"} backgroundColor={'white'}/>
        <ScrollView
        ...
        >
          <View style={{ flex: 1, width: '100%' }}>
            <WebView
              ...
              source={{ uri: `https://buykeyz.com/DeleteAccount` }}
